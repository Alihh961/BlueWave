 ...
 */
final class Version20231219084431 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_status_history ADD CONSTRAINT FK_471AD77EA35F2858 FOREIGN KEY (_order_id) REFERENCES `order` (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
